<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Uye_Default" EnableEventValidation="false" %>
                            ...
                            <figure class="card card-product-grid card-lg rounded-sm">
                                ...
                                <div class="bottom-wrap">
                                    ...
                                    <div class="price-wrap">
                                        <span class="price h5 text-danger font-weight-bold"><%#Eval("UrunCost") %> TL</span>
                                    </div>
                                </div>
                            </figure>
                        </div>
